      ...
      <div className="flex min-h-screen  justify-center my-7 ">
        <div className="w-full max-w-md  ">
          ...
          <SuccessModal
            ...
            title="Registration Successful" // Título personalizado
            message="Your account has been created successfully!" // Mensaje personalizado
          />{" "}
          {/* Renderiza el modal */}
        </div>
      </div>
